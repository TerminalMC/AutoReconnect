...
<img alt="Icon" width=100 src="./common/src/main/resources/assets/autoreconnectrf/icon.png">

## AutoReconnect (Reforged)

Automatically reconnect to servers after unintentional disconnection.

Based on [AutoReconnect](https://github.com/Bstn1802/AutoReconnect) by Bstn1802.
...
[![Available on Modrinth](https://img.shields.io/modrinth/dt/PRy8Khga?label=Available%20on%20Modrinth&logo=modrinth&logoColor=%2300AF5C)](https://modrinth.com/project/PRy8Khga)
[![Available on CurseForge](https://img.shields.io/curseforge/dt/1049892?label=Available%20on%20CurseForge&logo=curseforge)](https://curseforge.com/minecraft/mc-mods/autoreconnectrf)
[![Available on GitHub](https://img.shields.io/github/downloads/TerminalMC/AutoReconnect/total?label=Available%20on%20GitHub&logo=github&logoColor=white)](https://github.com/TerminalMC/AutoReconnect)

</center></div>

### About

If you get disconnected from a world or server without clicking the disconnect button (such as if
your internet briefly drops out), this mod will attempt to reconnect you.

By default, it will make 4 attempts after 3, 10, 30 and 60 seconds respectively. The number and
timing of attempts is fully configurable.

You can also configure messages or commands to be sent upon successful automatic reconnect to a
particular world or server.

<table style="width:100%;">
  <tr>
    <td style="width:50%;"><img alt="Reconnecting" src="./assets/images/reconnecting_01.png" style="width:100%;"></td>
    <td style="width:50%;"><img alt="Config" src="./assets/images/config_01.png" style="width:100%;"></td>
  </tr>
</table>
...
- [YACL](https://modrinth.com/project/1eAoo2KR)
...
AutoReconnect (Reforged) is based on [AutoReconnect](https://github.com/Bstn1802/AutoReconnect) by
Bstn1802 (discontinued), and includes code reused under license.

- For MC versions `1.16.2-1.20.1`, refer to the original mod
  on [GitHub](https://github.com/Bstn1802/AutoReconnect/releases),
  [Modrinth](https://modrinth.com/project/A9rziLV4)
  or [CurseForge](https://www.curseforge.com/minecraft/mc-mods/autoreconnect).
- For MC versions `1.20.2-1.20.6`, refer to the original fork
  on [GitHub](https://github.com/NotRyken/AutoReconnect/releases).
...
[![Issues](https://img.shields.io/github/issues/TerminalMC/AutoReconnect?logo=github&label=GitHub%20Issues)](https://github.com/TerminalMC/AutoReconnect/issues)
